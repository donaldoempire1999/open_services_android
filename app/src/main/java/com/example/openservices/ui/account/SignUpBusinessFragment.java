...
public class SignUpBusinessFragment extends Fragment {
    ...
    private FragmentSignUpBusinessBinding dataBiding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataBiding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_sign_up_business, container, false);
    ...
    private void setViews() {
        ...
        fragmentTransaction.setCustomAnimations(R.anim.enter_trans, R.anim.exit, R.anim.enter_trans, R.anim.exit);
